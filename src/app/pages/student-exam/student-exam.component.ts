...
ngOnInit(): void {
  utils.addButtonTitle.set('Student Exam');
  ...
  this.colDefs = [
    {
      ...
      header: 'Id',
      width: '5%',
      styleClass: 'studentExamId'
    },
    {
      field: 'StudentExam',
      header: 'Student Exam Name',
      width: '100%',
      styleClass: 'StudentExam'
    },
    {
      field: 'action',
      header: 'Action',
...
handleAddEditAction(data?: any) {
  ...
  this.dialogRef = this.dialogService.open(AddEditExamComponent, {
    ...
    header: this.isEditMode ? 'Edit Student Exam' : 'Add New Student Exam',
  });
