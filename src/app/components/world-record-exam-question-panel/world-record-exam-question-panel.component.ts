...
@Component({
  selector: 'app-world-record-exam-question-panel',
  standalone: true,
  imports: [CommonModule, QuestionPanelComponent, ProgressBarModule],
  templateUrl: './world-record-exam-question-panel.component.html',
  styleUrl: './world-record-exam-question-panel.component.scss'
})
export class WorldRecordExamQuestionPanelComponent implements AfterViewInit {
